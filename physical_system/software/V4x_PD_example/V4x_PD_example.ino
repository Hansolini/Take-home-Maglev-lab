...
constexpr float DIRECT_FEEDTHROUGH_SLOPE_X_POSITIVE = 1;
constexpr float DIRECT_FEEDTHROUGH_SLOPE_X_NEGATIVE = 1;
constexpr float DIRECT_FEEDTHROUGH_SLOPE_Y_POSITIVE = 1;
constexpr float DIRECT_FEEDTHROUGH_SLOPE_Y_NEGATIVE = 1;

// === PD Controller Gains ===
constexpr float Kp = 130.0;  // Proportional gain
constexpr float Kd = 0.5;    // Derivative gain

// === Filter Constants ===
constexpr float ALPHA = 0.10;   // Filter for magnetic field
constexpr float DALPHA = 0.02;  // Filter for derivatives
...
void loop() {
    ...
    if (currentTime - previousControlTime >= (unsigned long)controlInterval) {
        ...
        // if (controlLoopCounter % 500){
        //   pwmControlInputY = 80*(!pwmControlInputY);
        //   pwmControlInputX = 0;
        // }
